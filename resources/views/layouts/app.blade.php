...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{ asset('home')}}" class="logo">
            ...
            <span class="logo-mini"><b>سفره</b></span>
                                ...
                                <div class="pull-right">
                                    ...
                                    <a href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
                                        ...
                                        <i class="fa fa-btn fa-sign"></i> تسجيل خروج
                                    </a>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> الصفحه الرئيسيه</a></li>
...
<script src="{{ asset('') }}adminlte/js/jsm.js"></script>
<script>
